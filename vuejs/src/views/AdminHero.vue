...
export default{
	...
	methods:{
		getAllMembers: function(){
			var self = this;
			axios.get('http://localhost/officetask/database/hero.php')
		...
		saveMember: function(){
			...
			var self = this;
            //debugger;		
			axios.post('http://localhost/officetask/database/hero.php?crud=create', this.newMember)
				.then(function(response){
					console.log(response);
		...
		updateMember(){
			...
			axios.post('http://localhost/officetask/database/hero.php?crud=update', memForm)
				.then(function(response){
					console.log(response);
					self.clickVideo = {};
					if(response.data.error){
		...
		deleteMember(){
			var self = this;
			var memForm = self.toFormData(self.clickVideo);
			axios.post('http://localhost/officetask/database/hero.php?crud=delete', memForm)
				.then(function(response){
					//console.log(response);
					self.clickVideo = {};
					if(response.data.error){
